    ...
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div id="QuickLinks" runat="server" class="space-y-4">
                ...
                <ul class="space-y-2">
                    <li><a href="/events" class="text-gray-400 hover:text-white">Sự kiện</a></li>
                    <li><a href="/about" class="text-gray-400 hover:text-white">Về chúng tôi</a></li>
            ...
            <div id="SupportLinks" runat="server" class="space-y-4">
                ...
                <ul class="space-y-2">
                    <li><a href="/help" class="text-gray-400 hover:text-white">Trung tâm trợ giúp</a></li>
                    <li><a href="/terms" class="text-gray-400 hover:text-white">Điều khoản sử dụng</a></li>
                    <li><a href="/privacy" class="text-gray-400 hover:text-white">Chính sách bảo mật</a></li>
                    <li><a href="/refund" class="text-gray-400 hover:text-white">Chính sách hoàn tiền</a></li>
                </ul>
            </div>
