<%@ Page Title="" Language="C#" MasterPageFile="~/Page_Admin/Organizer/Admin.Master" AutoEventWireup="true" CodeBehind="Admin_Home.aspx.cs" Inherits="Online_ticket_platform.Page_Admin.Admin_Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkConstraints(id, callback) {
            $.ajax({
                url: 'Admin_Home.aspx/CheckConstraints',
                type: 'POST',
